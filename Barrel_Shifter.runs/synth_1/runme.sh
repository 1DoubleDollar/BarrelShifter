...
HD_PWD='C:/Users/ssoni/Barrel_Shifter/Barrel_Shifter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift.tcl
