...
HD_PWD='C:/Users/ssoni/Barrel_Shifter/Barrel_Shifter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift.tcl -notrace
